...
export function PlaceholderCard({ title, description, icon: Icon, actionText, onActionClick }) {
  return (
    <Card className="mt-4 max-w-5xl mx-auto sm:p-10 px-3 py-4 text-center bg-white shadow-lg border border-gray-200">
      ...
      {actionText && <MainButton onClick={onActionClick} icon={<PlusIcon />} children={actionText} className="mt-4" />}
    </Card>
  );
}
