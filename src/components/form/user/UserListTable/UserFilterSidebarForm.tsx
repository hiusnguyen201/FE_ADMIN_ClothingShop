...
type FilterParams = Pick<GetListUserPayload, "status" | "gender">;

type UserFilterSidebarFormProps = {
...
export function UserFilterSidebarForm({ onApplyFilter, values }: UserFilterSidebarFormProps) {
